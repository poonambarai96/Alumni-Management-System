...
public class forgname extends JFrame implements ActionListener {

    JLabel lbl_heading, lbl_batch;
  
    JButton b_show, b_exit;
    JTextField t_nameorg;
    JPanel p1,p2,p3;
   ...
   Font f1 = new Font("Arial", Font.BOLD, 20);
    ...
    public forgname() {
      ...
      //  c.setLayout(null);
        ...
        lbl_heading = new JLabel("organization name Wise Report",JLabel.CENTER);
      
        lbl_batch = new JLabel("enter a name:");
         ...
         //  String b = li_batch.getSelectedItem().toString().trim();
           String  b = t_nameorg.getText();
            ...
            try {
                ...
                String str = "select * from alutab where orgname="+"'"+b+"'";
