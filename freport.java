...
public class freport extends JFrame implements ActionListener {
   ...
   Font f1 = new Font("Arial", Font.BOLD, 20);
    ...
    public freport() {
      ...
      //  c.setLayout(null);
        ...
        lbl_heading = new JLabel("Batch Wise Report",JLabel.CENTER);
      
        lbl_batch = new JLabel("Select a Batch:");
    ...
    public void actionPerformed(ActionEvent ae)
    {
        if (ae.getSource() == b_show)
        {
         //  String b = li_batch.getSelectedItem().toString().trim();
           int  b =Integer.parseInt( li_batch.getSelectedItem().toString().trim());
            Connection conn;
            Statement stmt;
            ResultSet rs;
            int flag = 0;
            ...
            try {
                ...
                String str = "select * from alutab where batch="+b;
