...
public class forg extends JFrame implements ActionListener {
   ...
   Font f1 = new Font("Arial", Font.BOLD, 20);
    ...
    public forg() {
      ...
      //  c.setLayout(null);
        ...
        lbl_heading = new JLabel("org location Wise Report",JLabel.CENTER);
    ...
    public void actionPerformed(ActionEvent ae)
    {
        if (ae.getSource() == b_show)
        {
         //  String b = li_batch.getSelectedItem().toString().trim();
           String   b = l_orgloc.getSelectedItem().toString().trim();
            Connection conn;
            Statement stmt;
            ResultSet rs;
            int flag = 0;
            ...
            try {
                ...
                String str = "select * from alutab where orgloc="+"'"+b+"'";
